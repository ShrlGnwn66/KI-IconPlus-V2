                    ...
                    @foreach($newsImage as $image)
                        <article class="card__article swiper-slide">
                                ...
                                <div class="card__data">
                                    ...
                                    <p  class="card__date" class="card__date" data-id="{{ $image->date }}">{{ \Carbon\Carbon::parse($image->date)->format('j-F-Y') }}
                                    </p>
                                    <p class="card__description" data-id="{{ $image->description }}">{{ $image->description }}</p>
                                    <a href="{{ route('news', ['id' => $image->id]) }}" target="_blank" class="card__button">Baca Selengkapnya</a>
