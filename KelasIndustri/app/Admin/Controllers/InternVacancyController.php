...
class InternVacancyController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new InternVacancy());
    ...
    {
        $show = new Show(InternVacancy::findOrFail($id));
    ...
    {
        $form = new Form(new InternVacancy());
