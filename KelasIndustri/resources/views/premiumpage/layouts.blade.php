                ...
                <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
                    ...
                    <div>
                        ...
                        <a class="text-decoration-none p-2" href="https://www.instagram.com/pln.iconplus_jatengdiy/"
                            target="_blank">
                            <img class="mt-3" src="assets/images/userpremium/logo/ig_footer.png" alt=""
                                style="width: 30px; height: 30px" />
                        </a>
                        <a class="text-decoration-none p-2" href="" target="_blank">
                            <img class="mt-3" src="assets/images/userpremium/logo/wa_footer.png" alt=""
                                style="width: 30px; height: 30px" />
                        </a>
                        <a class="text-decoration-none p-2" href="https://plniconplus.co.id/" target="_blank">
                            <img class="mt-3" src="assets/images/userpremium/logo/web_footer.png" alt=""
                                style="width: 30px; height: 30px" />
                        </a>
                    </div>
                </div>
