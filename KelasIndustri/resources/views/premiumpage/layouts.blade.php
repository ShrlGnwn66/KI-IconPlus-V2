...
<html lang="en">
  <head>
    ...
    <script rel="stylesheet" href="js/sweet/sweetalert2.min.js"></script>
    ...
    <!-- custom footer -->
    <footer
      class="text-white text-center text-lg-start pt-5"
      ...
      <div class="container p-4">
        ...
        <div class="row mt-4">
          ...
          <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
            <img src="assets/images/userpremium/logo/logo_footer.png" alt="" width="120" />
            <div>
              ...
              <a
                ...
                href="https://www.instagram.com/pln.iconplus_jatengdiy/"
                target="_blank"
              >
                <img
                  class="mt-3"
                  src="assets/images/userpremium/logo/ig_footer.png"
                  alt=""
              ...
              <a class="text-decoration-none p-2" href="" target="_blank">
                <img
                  class="mt-3"
                  src="assets/images/userpremium/logo/wa_footer.png"
                  alt=""
                  style="width: 30px; height: 30px"
                />
              </a>
              ...
              >
                <img
                  class="mt-3"
                  src="assets/images/userpremium/logo/web_footer.png"
                  alt=""
                  style="width: 30px; height: 30px"
                />
              </a>
