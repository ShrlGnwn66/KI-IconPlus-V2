        ...
        <div class="container custom_galery-container">
            <div class="row">
                <div class="section-title text-center pb-4">
                    <h2 class="main-heading fw-semibold fs-2">Gallery Penguji UKK</h2>
                    <p class="text-muted">Dokumentasi dari Sekolah yang menggunakan Penguji
                        UKK dari kami</p>
                </div>
            </div>
            <div class="grid" style="position: relative;">
                @if ($galleryPengujiUKKItems->count() > 0)
                    @php
                        $filteredImages = [];
                    @endphp

                    @foreach ($galleryPengujiUKKItems as $item)
                    ...
                    @foreach ($recentImages as $picture)
                        @php
                            $item = $galleryPengujiUKKItems->first(function ($value) use ($picture) {
